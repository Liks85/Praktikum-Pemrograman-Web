...
<body>
    ...
    echo "<h1>BIO DATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Lilik Setyawan'></td></tr>";
    echo "<tr><td class='atas'>NIM :</td><td><input type='text' name='name' value='2170234024'></td></tr>";
    ...
    echo "<tr><td class='atas'>E-Mail :</td><td><input type='email' name='email' value='isibiodata@gmail.com'></td></tr>";
    echo "<tr><td class='atas'>Foto :</td><td><img src='lilik.png.jpeg' width='100px'></img></td></tr>";
